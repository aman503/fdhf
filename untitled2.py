...
def load_data():
    dataset_name = "globalterrorismdb.csv"
...
#for opening browser by default  
def open_browser():
...
def create_app():
    ...
    dcc.Tabs(id="Tabs", value="Map",children=[
        dcc.Tab(label="Map tool" ,id="Map tool",value="Map", children=[
            ...
            dcc.Dropdown(id='state-dropdown', options=[{'label': 'All', 'value': 'All'}],placeholder='Select State or Province',multi = True),
...
def update_ui(Tabs, month_value, date_value,region_value,country_value,state_value,city_value,attack_value,year_value,chart_year_selector, chart_dp_value, search, subtabs2):
    fig = None
     
    if Tabs == "Map":
        print("Data Type of month  = " , str(type(month_value)))
        print("Data of month  = " , month_value)
        
        print("Data Type of Day  = " , str(type(date_value)))
        print("Data of Day  = " , date_value)
        
        print("Data Type of region  = " , str(type(region_value)))
        print("Data of region  = " , region_value)
        
        print("Data Type of country  = " , str(type(country_value)))
        print("Data of country  = " , country_value)
        
        print("Data Type of state  = " , str(type(state_value)))
        print("Data of state  = " , state_value)
        
        print("Data Type of city  = " , str(type(city_value)))
        print("Data of city  = " , city_value)
        
        print("Data Type of Attack  = " , str(type(attack_value)))
        print("Data of Attack  = " , attack_value)
        
        print("Data Type of year  = " , str(type(year_value)))
        print("Data of year  = " , year_value)
        # year_filter
        year_range = range(year_value[0], year_value[1]+1)
        new_df = df[df["iyear"].isin(year_range)]
        
        # for filtering month value
        ...
        # for filteringregion, country, state, city value
